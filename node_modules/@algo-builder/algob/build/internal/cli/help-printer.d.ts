import { ParamDefinitions, TasksMap } from "../../types";
export declare class HelpPrinter {
    private readonly _programName;
    private readonly _version;
    private readonly _algobParamDefs;
    private readonly _tasks;
    constructor(_programName: string, _version: string, _algobParamDefs: ParamDefinitions, _tasks: TasksMap);
