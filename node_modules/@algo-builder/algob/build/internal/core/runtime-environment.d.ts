import type { EnvironmentExtender, Network, ResolvedConfig, RunTaskFunction, RuntimeArgs, RuntimeEnv, TasksMap } from "../../types";
export declare class Environment implements RuntimeEnv {
