...
function validateConfig(config) {
    ...
    throw new web_1.BuilderError(web_1.ERRORS.GENERAL.INVALID_CONFIG, { errors: errorList });
}
    ...
    if (config !== undefined && typeof config.networks === "object") {
        for (const [net, ncfg] of Object.entries(config.networks)) {
            ...
            for (let i = 0; i < (ncfg.accounts || []).length; ++i) {
                ...
                (0, account_1.validateAccount)(a, p);
            ...
            try {
                ...
                if (e instanceof z.ZodError) {
                    errors.appendErrors([(0, runtime_1.parseZodError)(e)]);
                }
            }
        }
    }
...
function validateChainCfg(ncfg, errors) {
