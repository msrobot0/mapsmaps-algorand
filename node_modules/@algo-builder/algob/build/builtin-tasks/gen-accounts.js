...
exports.writeToFile = exports.genAccounts = exports.mkAccounts = exports.getFilename = void 0;
...
function default_1() {
    (0, config_env_1.task)(task_names_1.TASK_GEN_ACCOUNTS, "Generates custom accounts (not safe for production use)")
...
async function mkAccounts(taskArgs, _env) {
    ...
    const n = taskArgs.n;
    if (n <= 0) {
        throw new web_1.BuilderError(web_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE, {
            value: n,
            name: 'n'
        });
    }
...
async function writeToFile(content, force, fileName) {
    await (0, project_structure_1.assertAllDirs)();
    try {
