...
exports.ERRORS = exports.pyTealErrors = exports.scriptErrors = exports.kmdNode = exports.algorandNode = exports.accountErrors = exports.pluginErrors = exports.taskErrors = exports.argumentErrors = exports.taskDefErrors = exports.networkErrors = exports.generalErrors = exports.ERROR_RANGES = exports.getErrorCode = exports.ERROR_PREFIX = void 0;
exports.ERROR_PREFIX = "ABLDR";
function getErrorCode(error) {
    return `${exports.ERROR_PREFIX}${String(error.number)}`;
}
...
You can learn how to use algob by reading the [Getting Started guide](./README.md).`
    ...
    INVALID_NODE_VERSION: {
        number: 2,
        message: "algob doesn't support your Node.js version. It should be %requirement%.",
...
Read the [documentation](https://github.com/scale-it/algo-builder) to learn how to define custom networks.`
    ...
    INVALID_GLOBAL_CHAIN_NAME: {
        number: 101,
        message: "algob was set to use chain_name %configChainName%, but connected to a chain with name %connectionChainName%.",
...
Please double check your transactions' parameters.`
    ...
    NO_KMD_ACCOUNT_AVAILABLE: {
        number: 106,
        message: "No local account was set and there are accounts in the KMD.",
...
Please double check your task definitions.`
    ...
    PARAM_CLASHES_WITH_ALGOB_PARAM: {
        number: 202,
        message: "Could not set param %paramName% for task %taskName% because its name is used as a param for algob.",
...
exports.ERRORS = {
    GENERAL: exports.generalErrors,
    NETWORK: exports.networkErrors,
    TASK_DEFINITIONS: exports.taskDefErrors,
    ARGUMENTS: exports.argumentErrors,
    ACCOUNT: exports.accountErrors,
    ALGORAND: exports.algorandNode,
    KMD: exports.kmdNode,
    BUILTIN_TASKS: exports.taskErrors,
    PLUGINS: exports.pluginErrors,
    SCRIPT: exports.scriptErrors,
    PyTEAL: exports.pyTealErrors
};
