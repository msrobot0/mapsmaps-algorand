...
export declare type AppArgs = Array<string | number>;
export declare type StackElem = bigint | Uint8Array;
export declare type TEALStack = IStack<bigint | Uint8Array>;
...
export declare type RuntimeAccountMap = Map<string, AccountAddress>;
...
export declare type TxReceipt = BaseTxReceipt | DeployedAppTxReceipt | DeployedAssetTxReceipt;
...
export interface Context {
    ...
    deployApp: (fromAccountAddr: string, flags: AppDeploymentFlags, approvalProgram: string, clearProgram: string, idx: number, scTmplParams?: SCParams) => DeployedAppTxReceipt;
...
export interface AppLocalStateM {
    id: number;
    'key-value': Map<string, StackElem>;
...
export declare enum TxOnComplete {
    NoOp = "0",
    OptIn = "1",
    CloseOut = "2",
    ClearState = "3",
...
export declare type AccountMap = Map<string, Account>;
/**
